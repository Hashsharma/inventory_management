...
# JWT Settings
SIMPLE_JWT = {
    'ACCESS_TOKEN_LIFETIME': timedelta(minutes=60),  # Access token lifetime (default is 5 minutes)
    'REFRESH_TOKEN_LIFETIME': timedelta(days=30),    # Refresh token lifetime (default is 1 day)
